...
doc_family: catalog
source_type: vehicle
title: "Fiche vehicule - LADA PRIORA Hatchback"
truth_level: L2
...
motorisations:
  ...
  - moteur: "1.6"
    ...
    code: "-"
problemes_connus:
  - "Alternateur: Voyant batterie allume moteur tournant"
  - "Alternateur: Batterie qui se decharge malgre les trajets"
  - "Alternateur: Phares qui faiblissent ou clignotent"
  - "Alternateur: Sifflement de la courroie d accessoire"
  - "Alternateur: Odeur de courroie brulee ou d electrique"
  - "Alternateur: Plus de 150 000 km ou tension de charge basse"
  - "Filtre à air: Perte de puissance a l acceleration"
  - "Filtre à air: Surconsommation de carburant anormale"
  - "Filtre à air: Fumee noire a l echappement"
  - "Filtre à air: Sifflement anormal a l admission"
  - "Filtre à air: Odeur de carburant non brule"
  - "Filtre à air: Plus de 30 000 km depuis le dernier changement"
  - "Butée d'embrayage: Bruit roulement quand appuie pedale"
  - "Butée d'embrayage: Sifflement grondement disparait relachant pedale"
  - "Butée d'embrayage: Pedale d embrayage qui vibre sous le pied"
pieces_usure:
  - "Alternateur (616 references)"
  - "Filtre à air (97 references)"
  - "Butée d'embrayage (93 references)"
  - "Filtre à huile (71 references)"
  - "Filtre à carburant (44 references)"
  - "Mâchoires de frein (25 references)"
  - "Batterie (16 references)"
  - "Liquide de frein (13 references)"
  - "Disque de frein (13 references)"
  - "Courroie d'accessoire (10 references)"
entretien:
  - "Vidange essence : 15 000 km ou 1 an"
  - "Controle general : tous les 20 000 km ou 1 an"
---

# LADA PRIORA Hatchback (2011-2015)
...
### Disque de frein
- Vibrations au volant au freinage (surtout a vitesse elevee)
