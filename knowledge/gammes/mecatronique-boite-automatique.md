...
phase5_enrichment:
  ...
  technical_notes:
    role: 'calculateur hydraulique integre a la BVA — gere les passages de rapports via electrovannes'
conseil_v5:
  _sync_source: __seo_gamme_conseil
  _sync_date: '2026-03-29'
  S1: >-
    Piloter electroniquement les passages de vitesses. Pièces liées : vérifier
    les composants adjacents lors du remplacement.
  S2: >-
    Intervalle : selon constructeur. Symptômes de défaillance : - Passages de
    rapports brutaux- Boite en mode degrade- Voyant boite de vitesses allume
  S3: >-
    Pour choisir le bon mécatronique boîte automatique pour votre véhicule : -
    Renseignez marque, modele, type puis comparez references et dimensions.
    Validez ensuite les contraintes de moteur pour confirmer Mécatronique boîte
    automatique.- Verifier la reference OE ou equivalence constructeur pour le
    vehicule exact- Respecter le type de boite (manuelle, automatique,
    robotisee) et sa generation- Controler la compatibilite des cannelures et
    dimensions avec le vehicule- Marques : SKF, GKN/Spidan (premium), Febi,
    Meyle (standard), Ridex, Topran (budget)- Budget : 1000 à 5000 EUR
  S4_DEPOSE: >-
  ...
  S5: >-
    Erreurs fréquentes avec le mécatronique boîte automatique : - Ne pas
    ...
    mode dégradé
  S6: >-
    Après le remplacement du mécatronique boîte automatique : - Verifier le
