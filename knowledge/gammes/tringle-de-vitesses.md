...
conseil_v5:
  ...
  S1: >-
    Transmettre le mouvement du levier vers la boite. Pièces liées : vérifier
    les composants adjacents lors du remplacement.
  S2: >-
    Intervalle : selon constructeur. Symptômes de défaillance : - Vitesses dures
    a passer- Levier de vitesses flottant- Craquements au passage des rapports
  S3: >-
    Pour choisir le bon tringle de vitesses pour votre véhicule : - Marque de
  ...
  S5: >-
    Erreurs fréquentes avec le tringle de vitesses : - Ne pas vérifier la
  ...
  S6: >-
    Après le remplacement du tringle de vitesses : - Eviter de laisser le pied
    sur la pedale d embrayage au point mort- Remplacement du kit complet (disque
