...
selection:
  ...
  - tier: Ampoule LED position compatible
  brands:
    premium:
    - Osram
    - Philips
...
diagnostic:
  ...
  - 'Usure ou defaillance causant : feu de position eteint'
  quick_checks:
  - 'Observer : feu de position eteint ?'
  - 'Observer : eclairage asymetrique ?'
...
rendering:
  pgId: '2126'
  intro_title: A quoi sert Ampoule feu de position ?
  risk_title: Pourquoi remplacer Ampoule feu de position a temps ?
  ...
  - question: Quand remplacer Ampoule feu de position ?
    answer: En cas de feu de position eteint ou de degradation mesurable, il faut controler rapidement avant panne secondaire.
...
doc_id: 2f5515f6-0417-5454-955b-581284efdfa2
content_hash: sha256:f8c4395a56d08eff
lang: fr
variants:
...
phase5_enrichment:
  ...
  technical_notes:
    type: 'W5W (T10) ou BA9s selon vehicule, faible puissance 5W'
conseil_v5:
  ...
  S2: >-
    Intervalle : selon constructeur. Symptômes de défaillance : - Feu de
    position eteint- Eclairage asymetrique- Voyant au tableau de bord
  S3: >-
    Pour choisir le bon ampoule feu de position pour votre véhicule : - Marque
    de votre véhicule- Modele de votre véhicule- Annee de votre véhicule-
    Marques : Osram, Philips (premium), Bosch, Hella (standard), Ridex (budget)-
    Budget : 30 à 200 EUR
  S4_DEPOSE: >-
  ...
  S5: >-
    Erreurs fréquentes avec le ampoule feu de position : - Ne pas vérifier la
  ...
  S6: >-
    Après le remplacement du ampoule feu de position : - Controle regulier du
    fonctionnement de tous les feux- Remplacement par paire pour eclairage
    homogene- Ne pas toucher l ampoule a mains nues (halogen: trace = point
    chaud)- Reglage des phares apres remplacement d ampoule ou d optique-
...
**Comment choisir Ampoule feu de position compatible avec mon vehicule ?**
Renseignez marque, modele, type moteur et annee, puis verifiez la reference exacte avant montage.

**Quand remplacer Ampoule feu de position ?**
En cas de feu de position eteint ou de degradation mesurable, il faut controler rapidement avant panne secondaire.

**Puis-je monter Ampoule feu de position sans verification atelier ?**
