...
phase5_enrichment:
  ...
  technical_notes:
    remplacement: 'si claquement persistant au ralenti malgre huile correcte = poussoirs hydrauliques uses'
conseil_v5:
  _sync_source: __seo_gamme_conseil
  _sync_date: '2026-03-29'
  S1: >-
    Transmettre le mouvement de l'arbre a cames aux soupapes. Pièces liées :
    vérifier les composants adjacents lors du remplacement.
  S2: >-
    Intervalle : selon constructeur. Symptômes de défaillance : - Claquement
    moteur au demarrage- Bruit qui persiste a chaud- Perte de puissance legere
  S3: >-
    Pour choisir le bon kit de poussoir culbuteur pour votre véhicule : - Marque
  ...
  S5: >-
    Erreurs fréquentes avec le kit de poussoir culbuteur : - Ne pas vérifier la
  ...
  S6: >-
    Après le remplacement du kit de poussoir culbuteur : - Controle visuel a
