...
phase5_enrichment:
  ...
  types_variants:
  - type: Pompe a engrenages (rotor interne)
    description: Rotor interieur entraine par le vilebrequin, debit proportionnel au regime
    era: standard
  - type: Pompe a debit variable
    description: Debit ajuste par le calculateur moteur, reduit les pertes parasites
