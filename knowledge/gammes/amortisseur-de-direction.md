...
phase5_enrichment:
  ...
  technical_notes:
    role: 'amorti les vibrations de direction (shimmy) transmises par la route au volant'
    remplacement: 'si vibrations volant a vitesse stable malgre equilibrage et geometrie OK'
conseil_v5:
