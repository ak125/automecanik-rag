...
class WikiIngester:
    ...
    def _chunk_text(self, text: str) -> list:
        """Split text into chunks using TokenAwareChunker.

        Heading-aware, FAQ/procedure-aware splitting with sentence
        boundary respect and small chunk merging.
        """
        ...
        return [c["content"] for c in raw_chunks]
...
def main():
    ...
    ingester = WikiIngester(
        weaviate_url=args.weaviate_url or _settings.weaviate_url,
        collection_name=args.collection or _settings.weaviate_collection_knowledge,
